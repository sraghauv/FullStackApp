export default function ({ place }) {
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-3 gap-3 mr-20 mt-3 z-0">
                {perks.includes('wifi') && (
                    <div className="flex">
                ...
                {perks.includes('parking') && (
                    <div className="flex">
                        ...
                        <div className="ml-2">  Parking </div>
                    </div>
                )}
                ...
                {perks.includes('pets') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Pets Allowed </div>
                    </div>
                )}
                ...
                {perks.includes('entrance') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Private Entrance </div>
                    </div>
                )}

                {perks.includes('kitchen') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Kitchen </div>
                    </div>
                )}
                ...
                {perks.includes('ac') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Air Conditioner </div>
                    </div>
                )}
                {perks.includes('workspace') && (
                    <div className="flex">
                ...
                {perks.includes('washer') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Washing Machine / Dryer </div>
                    </div>
                )}
                {perks.includes('grill') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Grill </div>
                    </div>
                )}
                {perks.includes('kayak') && (
                    <div className="flex">
                        ...
                        <span>Kayak</span>
                        <div className="ml-2"> Kayak </div>
                    </div>
                )}
                {perks.includes('beach') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Beach essentials (towels, umbrella, etc) </div>
                    </div>
                )}
                {perks.includes('selfCheckIn') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Self Check-In </div>
                    </div>
                )}
                {perks.includes('ping-pong') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Ping Pong Table </div>
                    </div>
                )}
                {perks.includes('billard') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Pool Table (Billard) </div>
                    </div>
                )}
                {perks.includes('gym') && (
                    <div className="flex">
                ...
                {perks.includes('console') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Video Games </div>
                    </div>
                )}
                {perks.includes('backyard') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Backyard </div>
                    </div>
                )}
                {perks.includes('cameras') && (
                    <div className="flex">
                        ...
                        <div className="ml-2"> Exterior security cameras </div>
                    </div>
                )}
